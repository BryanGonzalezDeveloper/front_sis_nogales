<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportesProvedor.aspx.cs" Inherits="S.I.S_Sistema_De_Ambulacias.Reportes.ReportesProvedor" %>
                    ...
                    <div class="nav">
                        ...
                        <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link" href="ReportesProvedor.aspx">Provedores</a>
            ...
            <form action="" runat="server">
                ...
                <main>
                    <div class="container w-100">
                        <h1 class="text-dark text-center my-5">Nombre De La Tabla</h1>
                    </div>
